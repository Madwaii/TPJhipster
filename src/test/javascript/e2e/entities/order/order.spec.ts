...
describe('Order e2e test', () => {
  ...
  it('should load Orders', async () => {
    ...
    expect(await orderComponentsPage.getTitle()).to.eq('myblogApp.order.home.title');
  ...
  it('should load create Order page', async () => {
    ...
    expect(await orderUpdatePage.getPageTitle()).to.eq('myblogApp.order.home.createOrEditLabel');
  ...
  it('should delete last Order', async () => {
    ...
    expect(await orderDeleteDialog.getDialogTitle()).to.eq('myblogApp.order.delete.question');
